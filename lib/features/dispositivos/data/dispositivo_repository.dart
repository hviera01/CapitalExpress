...
class DispositivoRepository {
  ...
  /// Se llama al iniciar sesion (ver InactividadGuard): actualiza (o
  /// crea, la primera vez) el registro de este equipo con la version
  /// instalada y quien inicio sesion ahora. No bloquea el arranque de
  /// la app si falla -- es solo informativo para el modulo de
  /// Dispositivos, nunca debe impedir que alguien pueda seguir usando
  /// la app.
